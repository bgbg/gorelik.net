...
![Thousands of randomly looking points. From https://myscholarlygoop.wordpress.com/2017/11/20/the-all-encompassing-figure/]({{ site.url }}{{ site.baseurl }}'/assets/img/2017/12/rplot05.png' ){:width="1000" :class="alignnone"}
...
![Screenshot: many images for the 2016 US elections]({{ site.url }}{{ site.baseurl }}'/assets/img/2017/12/screen-shot-2017-12-10-at-10-18-48.png' ){:width="3322" :class="alignnone"}
