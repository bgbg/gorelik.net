...
![]({{ site.baseurl }}/assets/img/2020/05/image-1.png){:width="1024"}
...
![]({{ site.baseurl }}/assets/img/2020/05/image-2.png){:width="1024"}*Don't publish graphs like this. Especially not in data visualization papers.*
