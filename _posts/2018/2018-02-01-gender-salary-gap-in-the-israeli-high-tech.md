...
![Gender compensation gap, 1-2 years of experience. Women earn less in 13 of 20 categories]({{ '/assets/img/2018/02/figure_001_one_year_.png' | relative_url }}){:width="497" :class="alignnone"}
...
![Gender compensation gap, more than 7 years of experience. Women earn less in 14 of 16 categories]({{ '/assets/img/2018/02/figure_002_seven_years_.png' | relative_url }}){:width="522" :class="alignnone"}

To complete the picture, let's look at the gap dynamics over the years in all the occupation fields in that report.

![Gender gap dynamics. 20 professional fields over different experience bins]({{ '/assets/img/2018/02/figure_004_dynamics_.png' | relative_url }}){:width="1140" :class="alignnone"}
