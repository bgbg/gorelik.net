...
![]({{ site.baseurl }}/assets/img/2020/08/image.png){:width="1024"}*A screenshot from circa 2016. Today we are less fanatic than that*
...
![]({{ site.baseurl }}/assets/img/2020/08/image-1.png){:width="1024"}*Can you be less perceptually uniform?*
...
![]({{ site.baseurl }}/assets/img/2020/08/image-2.png){:width="1024"}*Viridis, the new rainbow*
...
![]({{ site.baseurl }}/assets/img/2020/08/image-3.png){:width="1000"}
...
![]({{ site.baseurl }}/assets/img/2020/08/image-4.png){:width="1024"}
