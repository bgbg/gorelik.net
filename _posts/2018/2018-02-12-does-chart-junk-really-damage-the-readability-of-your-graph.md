...
![Two bar charts based on identical data. One  with "creative" illustrations. The other one only presents the data.]({{ '/assets/img/2018/02/dataink.png' | relative_url }}){:width="1200" :class="alignnone"}
