...
![]({{ '/assets/img/2017/04/before.png' | relative_url }}){:width="900" :class="alignnone"}
...
![]({{ '/assets/img/2017/04/after.png' | relative_url }}){:width="825" :class="alignnone"}
