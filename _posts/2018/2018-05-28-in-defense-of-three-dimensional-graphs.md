...
![Screenshot: a 3D pie chart with text "The only good thing about this pie chart is that it's starting to look more like [a] real pie"]({{ site.url }}{{ site.baseurl }}'/assets/img/2018/05/screen-shot-2018-05-28-at-14-41-43.png' ){:width="300" :class="alignnone"}
...
![Steve Jobs during a presentation, in front of a ]({{ site.url }}{{ site.baseurl }}'/assets/img/2018/05/screen-shot-2018-05-28-at-14-56-38.png' ){:width="1024" :class="alignnone"}
...
![Three joyplot examples]({{ site.url }}{{ site.baseurl }}'/assets/img/2018/05/joyplots.jpg' ){:width="1724" :class="alignnone"}
