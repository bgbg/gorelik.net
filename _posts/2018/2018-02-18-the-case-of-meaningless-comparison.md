...
![Screenshot that shows two time series curves: one for the observed and one for the predicted values]({{ site.url }}{{ site.baseurl }}'/assets/img/2018/02/screen-shot-2018-02-18-at-14-21-24.png' ){:width="2084" :class="alignnone"}
...
![Two curves representing two time series  Apple stock price and the same data shifted by one day]({{ site.url }}{{ site.baseurl }}'/assets/img/2018/02/aapl_stock_price.png' ){:width="661" :class="alignnone"}
...
![diff_series]({{ site.url }}{{ site.baseurl }}'/assets/img/2018/02/diff_series.png' ){:width="649" :class="alignnone"}
