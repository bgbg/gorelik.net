...
![]({{ site.url }}{{ site.baseurl }}'/assets/img/2020/11/image-6.png' ){:width="NaN"}

we tend to recommend a slope chart (or slope graph) like this 

![]({{ site.url }}{{ site.baseurl }}'/assets/img/2020/11/image-7.png' ){:width="220"}
...
![]({{ site.url }}{{ site.baseurl }}'/assets/img/2020/11/image-8.png' )
