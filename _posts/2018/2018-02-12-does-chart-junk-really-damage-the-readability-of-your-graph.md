...
![Two bar charts based on identical data. One  with "creative" illustrations. The other one only presents the data.]({{ site.url }}{{ site.baseurl }}'/assets/img/2018/02/dataink.png' ){:width="1200" :class="alignnone"}
