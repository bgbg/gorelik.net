...
![01_default]({{ site.url }}{{ site.baseurl }}'/assets/img/2017/11/01_default.png' ){:width="432" :class="alignnone"}

Immediately, you notice a problem: the names on the X axis are not readable. One way to make the labels readable is to enlarge the graph.![02_large_image]({{ site.url }}{{ site.baseurl }}'/assets/img/2017/11/02_large_image.png' ){:width="1296" :class="alignnone"}

Making larger graphs isn't always possible. So, the next default solution is to rotate the text labels.

![03_rotated]({{ site.url }}{{ site.baseurl }}'/assets/img/2017/11/03_rotated1.png' ){:width="864" :class="alignnone"}
...
![05_alternate_labels]({{ site.url }}{{ site.baseurl }}'/assets/img/2017/11/05_alternate_labels.png' ){:width="864" :class="alignnone"}
...
![07_horizontal_plot]({{ site.url }}{{ site.baseurl }}'/assets/img/2017/11/07_horizontal_plot.png' ){:width="864" :class="alignnone"}
...
![08_horizontal_plot_sorted]({{ site.url }}{{ site.baseurl }}'/assets/img/2017/11/08_horizontal_plot_sorted.png' ){:width="864" :class="alignnone"}
