...
![A typical line chart. The Y-axis is on the left]({{ site.url }}{{ site.baseurl }}'/assets/img/2017/11/line_chart_the_default_version1.png' ){:width="599" :class="alignnone"}
...
![A slightly improved version. The Y-axis is on the right, adjacent to the most recent data point]({{ site.url }}{{ site.baseurl }}'/assets/img/2017/11/line_chart_improved_version1.png){:width="612" :class="alignnone"}![](' )

Now, today's price of XYZ stock is visible more clearly. Let's make the most important values explicitly clear:

![The final version. The Y-axis is on the right, adjacent to the most recent data point. The axis ticks correspont to actual data points]({{ site.url }}{{ site.baseurl }}'/assets/img/2017/11/line_chart_even_better1.png){:width="614" :class="alignnone"}![](' )
